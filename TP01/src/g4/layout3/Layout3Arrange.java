...
public class Layout3Arrange implements IArrangeStrategy {
  ...
  public void arrange(Board board) {
    ...
    board.setItem(new Position(0, 8, 10), new Tile(TileKind.Wind, 2));
