...
\hyphenation{o-pe-ra-do-res con-fi-gu-ra-ción}
...
% 	\end{itemize}
	...
	\section{Resultados}
		...
		Dados los resultados obtenidos se puede concluir que el algoritmo
		genético puede resolver el problema.
		Sin la utilización del operador Backpropagation, encontrar un conjunto
		de pesos que haga que el error cuadrático medio sea menor a $0.1$ puede
		demorar varias generaciones.
		Si en cambio, hacemos uso del operador Backpropagation, se ve como
		el error cuadrático medio queda menor a $0.01$ en menos de $100$
		generaciones.
...
\begin{figure}[!ht]
	\begin{center}
		\subfigure[Únicamente Backpropagation]
			{\label{fig:onlyBP}\framebox{\includegraphics[scale=0.27]{./figures/OnlyBPFitness.png}}}
		\hspace{20pt}
