...
% 	\end{itemize}
	...
	\section{Resultados y Conclusiones}
		...
		Para comparar los distintos métodos de cruce, se realizaron 4 corridas distintas en donde se modifica unicamente el \textit{cruce}. En la figura \ref{fig:crossover_comparison} se pueden observar los 4 métodos de cruce distintos. Se observa en esta comparación que el mejor resultado obtenido es con el método de cruce \textit{Uniforme}. En el método \textit{Anular}, figura \ref{fig:crossover_anular}, se observa que el desvío estándar se encuentra en crecimiento, esto indíca que la población cada vez es más diversa. Por lo tanto la población comienza a diferenciarse.
