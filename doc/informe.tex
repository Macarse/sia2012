...
Si bien el resultado general es m\'as alentador, algo similar ocurre con los algoritmos inform\'daos, al obtener mejores resultados los que se caracterizan por recorrer en profundidad tales como \emph{Greedy} en contraposici\'on con los que tienden a expandir por nivel tales como \emph{Astar} como se puede observar en la tabla TABLAAAAAAAA\\
